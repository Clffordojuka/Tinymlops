...
def print_summary(config_path: str, train_metrics: dict, eval_metrics: dict, model_params: dict) -> None:
    ...
    print(f"Optimizer: {train_metrics.get('optimizer')}")
    print(f"Adam beta1: {train_metrics.get('adam_beta1')}")
    print(f"Adam beta2: {train_metrics.get('adam_beta2')}")
    print(f"Adam epsilon: {train_metrics.get('adam_epsilon')}")
    ...
    print(f"Weight init: {train_metrics.get('weight_init')}")
